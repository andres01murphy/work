...
<body>
    ...
    <p>Email <input class="form-control input-lg" type="text" id="email"></p>
    <p>Nombre <input class="form-control input-lg"  type="text" id="nombre"></p>
    <p>     <a href="iniciouser.html"> <button class="button" id="ingresar">Ingresar</button></a></p>
